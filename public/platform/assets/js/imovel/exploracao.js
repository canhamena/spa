var columnDefs = [
    ...
    {headerName: 'Referência', field: 'referencia', filter: 'agTextColumnFilter', chartDataType: 'category', enableRowGroup: true},
    {headerName: 'Cliente', field: 'cliente', filter: 'agTextColumnFilter', chartDataType: 'category', enableRowGroup: true},
    {headerName: 'Condomínio', field: 'condominio', filter: 'agSetColumnFilter', chartDataType: 'series', enableRowGroup: true},
    {headerName: 'Tipologia', field: 'tipologia', filter: 'agSetColumnFilter', chartDataType: 'series', enableRowGroup: true},
    {headerName: 'Tipo Imóvel', field: 'tipo_imovel', filter: 'agSetColumnFilter', chartDataType: 'series', enableRowGroup: true},
    {headerName: 'Estado', field: 'estado', filter: 'agSetColumnFilter', chartDataType: 'series', enableRowGroup: true},
    {headerName: 'Entregue', field: 'entregue', filter: 'agSetColumnFilter', chartDataType: 'series', enableRowGroup: true},
...
function RowClickedEvent (event) {

 window.location =  event.node.data.id +'/edit';
