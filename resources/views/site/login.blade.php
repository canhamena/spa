            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown active"> <a data-toggle="dropdown" href="#">Product / Shope <i class="fa fa-angle-down"></i></a>
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="login.html">Login Form For Products</a></li>
                </ul>
              </li>
...
<section id="page-heading">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 text-right"> <a href="index.html">Home <i class="fa fa-angle-double-right"></i></a> <span>Spa Products</span> </div> 
    </div>
  </div>
</section>
<!-- section -->
