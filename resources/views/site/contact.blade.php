...
<header id="navigation" class="navigation affix-top" data-offset-top="2" data-spy="affix">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-2 booking"> <a class="btn-booking text-center try sans hvr-ripple-out" href="#" data-toggle="modal" data-target="#myModal"> <i class="fa fa-calendar"></i> Booking Now </a> </div>
    </div>
  </div>
</header>
<!-- Header Ends --> 
...
<section id="page-heading">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 text-right"> <a href="index.html">Home <i class="fa fa-angle-double-right"></i></a> <span>Contact Us</span> </div>
    </div>
  </div>
</section>
<!-- section --> 
    ...
    <div class="form-area-wrap padding_top">
      ...
      <div class="form-area">
        <form name="contactForm" method="post"  novalidate id="contact" class="contact-form" data-ng-controller='themeonCtrl'>
          ...
          <div class="col-xs-12">
            <div class="submit-btn"> <a href="#" class="btn-slide animation animated-item-1 hvr-ripple-out">Submit</a> </div>
          </div>
        </form>
        <div style="display: none" id="contactSuccess"> <span>Hey! Thanks for reaching out. I will get back to you soon</span> </div>
      </div>
    </div>
...
<section class="contact-us" id="contact-us">
  <div class="container">
    <div class="heading text-center">
      <h2>Contact Us</h2>
      <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam rutrum augue nec augue aliquam facilisis. Vivamus malesuada dolor molestie vel nunc. </p>
    </div>
    <div class="col-xs-12 col-sm-4">
      <div class="contact-info"> <a href="#" class="contact-icon"><i class="fa fa-phone"></i> </a> <a href="tel:6601234567890" class="contact-text"> +66 (0)123 456 7890</a> </div>
    </div>
    <div class="col-xs-12 col-sm-4">
      <div class="contact-info"> <span  class="contact-icon"><i class="fa fa-map-marker"></i> </span> <span class="contact-text"> 3481 Melrose Place Beverly Hills, CA 90210</span> </div>
    </div>
    <div class="col-xs-12 col-sm-4">
      <div class="contact-info"> <a href="#" class="contact-icon"><i class="fa fa-envelope"></i> </a> <a href="mailto:admin@trasuaemplate.com" class="contact-text"> admin@beautyspa.com</a> </div>
    </div>
