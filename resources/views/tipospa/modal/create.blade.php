          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"> <i class="fa fa-bullseye"></i> Adicionar tipo de spa</h4>
              </div>
              <div class="modal-body">
               ...
               @if($errors->any())
                ...
                <form class="form-horizontal" id="entryForm" action="{{url('tipo/store')}}" method="post" enctype="multipart/form-data">
