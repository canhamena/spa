<div class="modal fade" id="modal-create-contacto">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
               ...
               @if($errors->any())
                ...
                <form class="form-horizontal" id="entryForm" action="{{url('contacto/store')}}" method="post" enctype="multipart/form-data">
