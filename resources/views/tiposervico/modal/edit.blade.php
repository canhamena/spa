<div class="modal fade" id="modal-editar-tiposervico">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"> <i class="fa fa-bullseye"></i> Editar tipo serviço</h4>
              </div>
              <div class="modal-body">
               ...
               @if($errors->any())
                 ...
                 @endif
                <form class="form-horizontal" id="entryForm" action="{{url('tiposervico/update-servico')}}" method="post" enctype="multipart/form-data">
                  @csrf
                  <input type="hidden" name="tiposervico_id" id="id">
                  ...
                  <div class="form-group has-feedback @error('preco') has-error @enderror">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="preco" id="preco_valor"  class="form-control" id="inputName"  placeholder="" required>
                    </div>
                    <span class="text-danger">
                        @error('preco')
                          {{ $message }}
