<div class="modal fade" id="modal-create-endereco">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"> <i class="fa fa-bullseye"></i> Adicionar Localização</h4>
              </div>
              <div class="modal-body">
               ...
               @if($errors->any())
                ...
                <form class="form-horizontal" id="entryForm" action="{{url('localizacao/store')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control select2" 
                        style="width: 100%;" name="provincia" id="localizacao_p">
                  ...
                  <div class="form-group">
                    <label for="inputEmail" class="col-sm-2 control-label">Município<span class="text-danger">*</span></label>
                       <div class="col-sm-10">
                      <select class="form-control select2" 
                        style="width: 100%;" name="municipio" id="localizacao_m">
