...
<html>
	...
	<body>
		<header>
			<img src="{{public_path("storage/imagem/banner_a4_horizontal.png")}}" width="1550" height="120">
		</header>
		<br><br>
		...
		<footer>
			...
			<div style="float: left; font-family: Arial Narrow, sans-serif  ">|<small> Muxima - Gestão de Spa</small> </div>
				...
				@endphp
			<div style="margin-left:  1135px; font-family: Arial Narrow, sans-serif "><small>  Utilizador : {{$nome}} ,  &nbsp; {{date('d-m-Y')}} - Processado por compudador </small></div>
		</footer>
